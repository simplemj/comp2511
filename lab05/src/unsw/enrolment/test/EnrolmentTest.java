...
public class EnrolmentTest {
    ...
    public static void main(String[] args) {
        ...
        Mark comp1511Ass1 = new Mark("Ass1",30,30);
        comp1511Enrolment.addMark(comp1511Ass1);
        // DONE Give the student a passing mark for milestone 1 of assignment 2
        Mark comp1511Ass2Milestone1 = new Mark("milestone1",15,30);
        comp1511Enrolment.addMark(comp1511Ass2Milestone1);
        // DONE Give the student a passing mark for milestone 2 of assignment 2
        Mark comp1511Ass2Milestone2 = new Mark("milestone2",15,30);
        comp1511Enrolment.addMark(comp1511Ass2Milestone2);
        // DONE Give the student an assignment 2 mark which is the average of
        // milestone 1 and 2
        comp1511Enrolment.CalculateAverage("Ass2","milestone1", "milestone2");
        // DONE Give the student a prac mark which is the sum of assignment 1
        // and 2
        comp1511Enrolment.CalculateSum("Prac","Ass1", "Ass2");
        // DONE Give the student a passing exam mark.
        Mark comp1511Finalexam = new Mark("Final exam",30,40);
        comp1511Enrolment.addMark(comp1511Finalexam);
        comp1511Enrolment.CalculateSum("Final Mark", "Prac","Final exam");
